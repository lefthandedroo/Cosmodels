        ...
        if key == 'rainbow':
            ...
            if 0 < th[2] < 1 and 0 < th[3] < 1 and 0 < th[4] < 1 and 0 < th[5] < 1:
                ...
                if 0 < th[6] < 1 and 0 < th[7] < 1 and 0 < th[8] < 1 and 0 < th[9] < 1:
                    l = 1
                    # r_in, s_in, t_in
                    if -l < th[10] < l and -l < th[11] < l and -l < th[12] < l:
                        # u_in, v_in, w_in
                        if  -l < th[13] < l and -l < th[14] < l and -l < th[15] < l:
                            # x_in, y_in, z_in
                            if -l < th[16] < l and -l < th[17] < l and -l < th[18] < l:
                                return 0.0
        elif key == 'kanangra':
            # ombar_radiation, a_ombar, b_ombar, c_ombar
            if 0 < th[2] < 1 and 0 < th[3] < 1 and 0 < th[4] < 1 and 0 < th[5] < 1:
...
#                    if -0.01 < th[9] < l and -0.01 < th[10] < l:
                if -l < th[6] < l and -l < th[7] < l and -l < th[8] < l:
                    if -l < th[9] < l and -l < th[10] < l:
                        return 0.0
...
#                if -0.01 < th[4] < l and -0.01 <th[5] < l and -0.01 < th[6] < l:
                if -l < th[4] < l and -l <th[5] < l and -l < th[6] < l:
